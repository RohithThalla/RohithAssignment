...
public class Assignment3 {
	...
	public void framesTest() throws InterruptedException {
		...
		driver.findElement(By.xpath("//ul[@id='myPager']"));
		...
		driver.findElement(By.xpath("//input[@name='last_name']")).sendKeys("Thalla");
		...
		driver.findElement(By.xpath("//input[@name='zip']")).sendKeys("abc");
